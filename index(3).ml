...
<body>
    ...
    -->
    <script src='//libtl.com/sdk.js' data-zone='10123139' data-sdk='show_10123139'></script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            watchAdBtn.addEventListener('click', () => {
                ...
                // নিচের 'show_10123139()' লাইনটি একটি উদাহরণ।
                // ======================================================================
                if (typeof show_10123139 === 'function') {
                    show_10123139('pop').then(() => { // Changed to call the rewarded popup
